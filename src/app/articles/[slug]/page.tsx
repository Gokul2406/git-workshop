...
export default async function Article({ params }) {
  ...
  return (
    ...
    <div className="flex flex-col w-screen">
      ...
      <div className="w-3/5 h-screen flex flex-col bg-[#11111B] p-16">
        ...
        <Markdown className={`prose prose-base max-w-none prose-p:text-[#CAD3F5] ${robotoMono.className} prose-code:text-lg ${VT323_font.className} prose-p:text-xl prose-headings:text-[#cba6f7] prose-li:text-[#CAD3F5] prose-a:text-[#94e2d5] prose-strong:text-[#f9e2af] prose-code:text-[#f5c2e7]`}>{article.content}</Markdown>
      </div>
      </div>
    </div>
    </>
